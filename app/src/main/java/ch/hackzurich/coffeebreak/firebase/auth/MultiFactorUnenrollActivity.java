package ch.hackzurich.coffeebreak.firebase.auth;
...
import ch.hackzurich.coffeebreak.databinding.ActivityMultiFactorSignInBinding;
...
public class MultiFactorUnenrollActivity extends BaseActivity {
    ...
    private View.OnClickListener generateFactorOnClickListener(final PhoneMultiFactorInfo phoneMultiFactorInfo) {
